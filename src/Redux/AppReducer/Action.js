...
export const Get_All_Data=()=>(dispatch)=>{
   axios.get("https://farmer-server1.herokuapp.com/data").then((r)=>{
...
export const Get_Cart_Data=()=>(dispatch)=>{
   axios.get("https://farmer-server1.herokuapp.com/cart",{withCredentials:true}).then((r)=>{
...
export const Get_MyPosts_Data=()=>(dispatch)=>{
   axios.get("https://farmer-server1.herokuapp.com/myposts",{withCredentials:true}).then((r)=>{
      console.log(r.data.data,);
...
export const Sigup_Success=(alert,payload,navigate)=>(dispatch)=>{
   axios.post("https://farmer-server1.herokuapp.com/signup",payload).then((r)=>{
...
export const Login_Success=(alert,payload,navigate)=>()=>{
    axios.post("https://farmer-server1.herokuapp.com/login",payload,{withCredentials:true}).then((r)=>{
 ...
 export const AddToCart=(Id,alert)=>(dispatch)=>{
    axios.get(`https://farmer-server1.herokuapp.com/${Id}/addtocart`,{withCredentials:true}).then((r)=>{
        console.log(r);
...
export const Upload_Issue=(formData,alert)=>(dispatch)=>{
   ...
   axios.post("https://farmer-server1.herokuapp.com/uploadIssue",formData,{withCredentials:true},{headers:{"Content-Type":"multiple/form-data"}}).then((r)=>{
...
export const Logout=()=>(dispatch)=>{
   console.log(1,"ji");
   axios.get(`https://farmer-server1.herokuapp.com/logout`,{withCredentials:true}).then((res)=>{
...
export const Delete=(Id,alert)=>()=>{
   axios.get(`https://farmer-server1.herokuapp.com/${Id}/delete`,{withCredentials:true}).then((r)=>{
...
export const PermenentDelete=(Id,alert)=>(dispatch)=>{
   axios.get(`https://farmer-server1.herokuapp.com/${Id}/permenentDelete`,{withCredentials:true}).then((r)=>{
      console.log(r.data);
